...
import { buttonSizeTokens, colorTokens } from './tokens.js';
...
const darkPalette: Theme['palette'] = {
  ...
  background: { default: colorTokens.dark.background, paper: colorTokens.dark.paper },
  text: {
...
const darkTypography: Theme['typography'] = {
...
const darkComponents: Theme['components'] = {
  MuiButton: {
    styleOverrides: {
      ...
      containedPrimary: {
        ...
        '&:hover': {
          background: colorTokens.gold[400],
  ...
  MuiChip: {
    styleOverrides: {
      outlined: { borderColor: colorTokens.gold[500], color: colorTokens.gold[500] },
    },
  },
};
